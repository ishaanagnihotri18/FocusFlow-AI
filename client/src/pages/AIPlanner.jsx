...
const PLANNER_API = `${API_BASE_URL}/generate-plan`;;
...
export default function AIPlanner() {
  ...
  const generatePlan = async () => {
    // Only pending tasks should be planned
    ...
    if (pendingTaskList.length === 0) {
      toast.info(
        "Add a pending task before generating a schedule."
      );
    ...
    <>
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-400 mt-3 leading-7">
          Generate a personalized study and work
          schedule using Google's Gemini AI based on
          your current tasks, priorities and deadlines.
        </p>
      </div>
      ...
      <div className="bg-slate-800 rounded-2xl p-8 mb-8">
        ...
        <ul className="space-y-3 text-gray-300 leading-7">
          ...
          <li>
            ✅ High-priority tasks receive greater
            importance.
          </li>

          <li>
            ✅ Deadlines are considered while generating
            your schedule.
          </li>

          <li>
            ✅ Gemini creates a personalized plan based
            on your workload.
          </li>
        </ul>
      </div>
      ...
      {aiPlan && (
        <div className="bg-slate-800 rounded-2xl p-8 border border-cyan-500/20">
          ...
          <p className="text-xs text-gray-500 mt-6 text-center">
            💡 This schedule is generated by Gemini AI
            based on your current tasks, priorities and
            deadlines. You can adjust it according to
      ...
      {!aiPlan && !loading && (
        <div className="bg-slate-800 rounded-2xl p-10 border border-dashed border-slate-700 text-center">
          ...
          <p className="text-gray-400 leading-7 max-w-2xl mx-auto">
            {pendingTasks === 0
              ? "Add a new task or create your next goal before generating a personalized schedule."
              : (
                <>
                  Click{" "}
                  <strong>
                  ...
                  and Gemini AI will analyze your pending
                  tasks, priorities and deadlines to
                  create a customized productivity plan.
                </>
              )}
          </p>
        </div>
